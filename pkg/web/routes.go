...
func AddRoutes(router *gin.Engine) {
	router.GET("/status", Safe(getStatus))
	router.GET("/sockets", Safe(getSockets))
	router.GET("/sockets/:id", Safe(getSocketById))
	router.POST("/sockets/reset", Safe(resetSockets))
	router.POST("/sockets/:id/reset", Safe(resetSocketById))
	router.GET("/sockets/:id/image", Safe(getImageBySocketId))
	router.GET("/sockets/:id/basecaller", Safe(getBasecallerBySocketId))
	router.POST("/sockets/:id/basecaller/start", Safe(startBasecallerBySocketId))
	router.POST("/sockets/:id/basecaller/stop", Safe(stopBasecallerBySocketId))
	router.POST("/sockets/:id/basecaller/reset", Safe(resetBasecallerBySocketId))
	router.GET("/sockets/:id/darkcal", Safe(getDarkcalBySocketId))
	router.POST("/sockets/:id/darkcal/start", Safe(startDarkcalBySocketId))
	router.POST("/sockets/:id/darkcal/stop", Safe(stopDarkcalBySocketId))
	router.POST("/sockets/:id/darkcal/reset", Safe(resetDarkcalBySocketId))
	router.GET("/sockets/:id/loadingcal", Safe(getLoadingcalBySocketId))
	router.POST("/sockets/:id/loadingcal/start", Safe(startLoadingcalBySocketId))
	router.POST("/sockets/:id/loadingcal/stop", Safe(stopLoadingcalBySocketId))
	router.POST("/sockets/:id/loadingcal/reset", Safe(resetLoadingcalBySocketId))
	router.GET("/storages", Safe(listStorageMids))
	router.POST("/storages", Safe(createStorage))
	router.GET("/storages/:mid", Safe(getStorageByMid))
	router.DELETE("/storages/:mid", Safe(deleteStorageByMid))
	router.POST("/storages/:mid/free", Safe(freeStorageByMid))
	router.GET("/postprimaries", Safe(listPostprimaryMids))
	router.POST("/postprimaries", Safe(startPostprimary))
	router.DELETE("/postprimaries", Safe(deletePostprimaries))
	router.GET("/postprimaries/:mid", Safe(getPostprimaryByMid))
	router.DELETE("/postprimaries/:mid", Safe(deletePostprimaryByMid))
	router.POST("/postprimaries/:mid/stop", Safe(stopPostprimaryByMid))
}
